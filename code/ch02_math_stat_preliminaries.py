...
def write_tex_macros(path: Path, macros: dict[str, str]) -> None:
    ...
    lines = [
        "% Auto-generated by code/ch02_math_stat_preliminaries.py; "
        "do not edit.",
        "",
    ]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Write LaTeX macros with key numeric results to this path "
        "and exit.",
    )
...
series.plot(
    kind="hist", bins=60, density=True, alpha=0.6,
    label=f"{asset} log-ret",
)
